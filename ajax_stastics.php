...
$action=date('Y');
						...
						$sql_graphdetails=mysqli_query($conn, "select DATE_FORMAT(iot_datetime, '%Y-%m') as iotyear_month, count(iot_id) as total_count  from  tbl_iot_details where DATE_FORMAT(iot_datetime, '%Y')='$action' and iot_imeino<>'' group by DATE_FORMAT(iot_datetime, '%Y-%m')");
						$jan_moth="";
						$feb_moth="";
						$mar_moth="";
						$apr_moth="";
